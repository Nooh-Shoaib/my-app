...
// const Footer = () => {
//   return (
//     <footer aria-label='Site Footer' className='bg-zinc-100 dark:bg-zinc-900'>
...
//         <p className='mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-700 dark:text-gray-300'>
//           Step into a world of magic and efficiency as you create shorter links
//           with Spit-sh, empowering your online presence.
//         </p>
