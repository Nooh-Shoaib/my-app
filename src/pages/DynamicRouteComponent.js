...
//                 className="hover:scale-110 duration-500 cursor-pointer lg:w-full w-72"
//               />
//               <div className="absolute lg:top-[50%] top-32 lg:space-x-[354px] space-x-[195px]  mx-3">
//                 <button onClick={handlePrevious} className="prev-button text-2xl ">
//                   <i className="fa-solid fa-chevron-left"></i>
//                 </button>
//                 <button onClick={handleNext} className="next-button text-2xl">
//                   <i className="fa-solid fa-chevron-right"></i>
//                 </button>
//               </div>
//             </div>
