...
const images = [
        ...
        'https://s3.amazonaws.com/sireprinting.com/products/1627779425CBD-Essential-Oil-Boxes-02.png-gallery1', 
 
       ];
const CBDEssentialOilBoxes = () => {
        ...
        return (
                ...
                <Layout>
                        <div className='mt-10'>
                                <h2 className='text-4xl font-medium text-center'>CBD Essential Oil Boxes</h2>
...
export default CBDEssentialOilBoxes;