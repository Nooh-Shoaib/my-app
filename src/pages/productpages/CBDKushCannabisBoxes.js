...
const images = [
        ...
        'https://s3.amazonaws.com/sireprinting.com/products/1627831048CBD%20Kush%20Cannabis%20Boxes%20SirePrinting%2002.png-gallery1',

];
const CBDKushCannabisBoxes = () => {
        ...
        return (
                ...
                <Layout>
                        <div className='mt-10'>
                                <h2 className='text-4xl font-medium text-center'>Custom CBD Kush Cannabis Boxes</h2>
...
export default CBDKushCannabisBoxes;