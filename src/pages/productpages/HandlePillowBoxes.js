...
const images = [
        ...
        'https://res.cloudinary.com/sireprinting/image/upload/v1599871583/handle-pillow-boxes-gallery1.png',
        'https://res.cloudinary.com/sireprinting/image/upload/v1599871591/handle-pillow-boxes-gallery2.png',
        'https://res.cloudinary.com/sireprinting/image/upload/v1599871592/handle-pillow-boxes-gallery3.png',
        'https://res.cloudinary.com/sireprinting/image/upload/v1599871593/handle-pillow-boxes-gallery4.png',

];


const HandlePillowBoxes = () => {
...
export default HandlePillowBoxes;