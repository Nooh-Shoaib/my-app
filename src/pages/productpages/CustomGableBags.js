...
const images = [
        ...
        'https://res.cloudinary.com/sireprinting/image/upload/v1600704288/gable-bag-gallery1.jpg',
        'https://res.cloudinary.com/sireprinting/image/upload/v1600704289/gable-bag-gallery2.jpg',

];


const CustomGableBags = () => {
...
export default CustomGableBags;