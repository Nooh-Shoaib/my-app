...
const pageTitle = "Eco-Friendly Packaging"
const homeLink = "/"
const banner = "https://res.cloudinary.com/sireprinting/image/upload/v1613521759/eco-friendly-packaging1.png";
const linkLabel = "Home";
const Label = "Eco-Friendly Packaging";
...
const EcoFriendly = () => {
	const siteTitle = 'Eco-Friendly| CBD Packaging Wholesale | Sire Printing';
